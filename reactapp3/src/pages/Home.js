...
export default function Home() {
    ...
    useEffect(() => {
      fetch('http://localhost:8080/productall')
          .then(res => res.json())
        ...
        <div className="container-fluid services py-5">
            <div className="container text-center py-5">
                ...
                <div className="row g-5">
                    ...
                    {/* {
                        course.map(items=> <div className="col-xxl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".3s">
                        <div className="bg-light rounded p-5 services-item">
                            ...
                            <span> <b>${items.price} </b></span><br />
                            <button type="button" className="btn btn-primary border-0 rounded-pill px-4 py-3">Learn More</button>
                            <button type="button" className="btn btn-info border-0 rounded-pill px-4 py-3">Add to Cart</button>
                        </div>
                    </div>)
                    } */}
                </div>
